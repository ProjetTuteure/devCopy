...
public class Revendeur {
     ...
     * @param idRevendeur l'idRevendeur � setter
     */
     ...
     * @param nomRevendeur le nom du revendeur � setter
     */
    ...
    /**
     * Retourne le t�l�phone du revendeur
     * @return telRevendeur le t�l�phone du revendeur
     */
    ...
    /**
     * Setter du t�l�phone du revendeur
     * @param telRevendeur le t�l�phone du revendeur � setter
     */
     ...
     * @param adresseRevendeur l'adresse du revendeur � setter
     */
    ...
    /**
     * Retourne le num�ro de mobile du revendeur
     * @return le num�ro de mobile du revendeur
     */
     ...
     * @param mobileRevendeur le mobile du revendeur � setter
     */
     ...
     * @param faxRevendeur le num�ro de fax du revendeur � setter
     */
     ...
     * @param emailRevendeur l'email du revendeur � setter
     */
