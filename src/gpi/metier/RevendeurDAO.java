...
public class RevendeurDAO {
	...
	/**
	 * Permet d'ajouter un revendeur � la bd
	 * @param revendeur le revendeur � ajouter � la base de donn�es
	 */
	 ...
	 * @param revendeur le revendeur � modifier
	 */
	 ...
	 * @param revendeur le revendeur � supprimer
	 */
	 ...
	 * @param idRevendeur l'id du revendeur � retourner
	 * @return revendeur le revendeur correspondant � l'id pass� en param�tre
	 */
